#Here i am using Tkinter library for creating the registration form and storing the data in json file named as Data_stored.
...
def save_registration():
    ...
    with open("Data_stored.json", "w") as json_file:
